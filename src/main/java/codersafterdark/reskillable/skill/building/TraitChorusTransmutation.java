...
public class TraitChorusTransmutation extends TraitTransmutation {
    ...
    public TraitChorusTransmutation() {
        super(new ResourceLocation(MOD_ID, "chorus_transmute"), 3, 2, new ResourceLocation(MOD_ID, "building"),8, new ItemStack(Items.CHORUS_FRUIT), makeMap(), "building:16,magic:16");
    }
